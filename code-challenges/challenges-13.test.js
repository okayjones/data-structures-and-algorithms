...
const firstLetters = (arr) => arr.map(word => word.charAt(0));
...
const findHappiness = (arr) => arr.filter(word => word.includes(':)'));
...
const standardizePhoneNumbers = (arr) => arr.map(word => word.replace(/[\s-()]/g,''));
...
const sortByDay = (arr) => {
  let result = [];
  result.push(arr.filter(str => str.includes('Monday')));
  result.push(arr.filter(str => str.includes('Tuesday')));
  result.push(arr.filter(str => str.includes('Wednesday')));
  result.push(arr.filter(str => str.includes('Thursday')));
  result.push(arr.filter(str => str.includes('Friday')));
  result.push(arr.filter(str => str.includes('Saturday')));
  result.push(arr.filter(str => str.includes('Sunday')));
  return result;
};
